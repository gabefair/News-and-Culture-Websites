...
#connect to mongodb
# allow for space bar to pause
# allow for enter to not "lock" the terminal preventing input
# allow for up arrow to increaae the delay
# Allow for down arrow to decrese the delay
# Allow for right arrow to skip to next
# Allow for left arrow to retry previous
